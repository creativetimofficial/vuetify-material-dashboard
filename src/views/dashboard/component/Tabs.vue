    ...
    <v-row>
        ...
        <v-card class="mt-0">
          <v-card-text>
            ...
            <base-material-tabs color="success" vertical>
              <v-tab v-for="(t, i) in tabs" :key="i" class="mb-1">
                {{ t }}
              </v-tab>
        ...
        <v-card>
          <v-card-text>
            ...
            <base-material-tabs color="success" icons-and-text vertical>
              <v-tab v-for="(tab2, i) in tabs2" :key="i" class="mb-5">
                {{ tab2.text }}
                <v-icon v-text="tab2.icon" />
              </v-tab>
      ...
      <v-col class="mx-auto" cols="12" md="8">
        ...
        <base-material-tabs
          ...
          icons-and-text
        >
          <v-tab v-for="(tab3, i) in tabs3" :key="i">
            {{ tab3.text }}
            <v-icon v-text="tab3.icon" />
          </v-tab>
